    ...
    >
      ...
      <div className="card-body text-secondary-content">
        <div className="flex items-center justify-between">
          <h2 className="card-title text-white ">{saloonItem.name}</h2>
          <span className="flex items-center text-white">
            <FaRegStar /> &nbsp; {saloonItem.rating}
          </span>
        </div>
        <p className="text-white">{saloonItem.address}</p>
        <div className="card-actions justify-end">
          <button className="btn btn-base bg-white text-black">Book Now</button>
        </div>
      </div>
    </div>
  );
